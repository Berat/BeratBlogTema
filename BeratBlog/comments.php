...
<h5>Bu Yazı İçin <?php comments_number('Hiç Yorum Yapılmamış.', '1 Yorum Yapılmış.', '% Yorum Yapılmış.' );?></h5>
...
<em>Yorumunuz denetim için onay bekliyor.</em>
<?php endif; ?>  
</li>
<!-- Geriizleme bitiş -->
...
<div id="respond">
<h5>
<?php comment_form_title( '<br />Bu Yazı İçin Hiç Yorum Yapılmamış. ', '%s adlı kişinin yorumuna cevap yazıyorsunuz.' ); ?>
...
//<![CDATA[
(function() {
document.write('<p><textarea name="comment" id="comment" cols="70" rows="7" tabindex="4" placeholder="Yorumunu yaz."></textarea></p>');
})();
//]]>
</script>
<p><input name="submit" type="submit" id="submit" tabindex="5" value="Yorumunu Gönder" /><?php comment_id_fields(); ?></p>
